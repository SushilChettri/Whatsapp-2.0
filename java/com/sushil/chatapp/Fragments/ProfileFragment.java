...
public class ProfileFragment extends Fragment {
    ...
    private Task<Uri> uploadImage(Task task) throws Exception {
        final ProgressDialog pd = new ProgressDialog(getContext());
        pd.setMessage("Uploading");
        pd.show();

        if (imageUri != null) {
            final StorageReference fileReference = storageReference.child(System.currentTimeMillis() + "_" + getFileExtension(imageUri));
